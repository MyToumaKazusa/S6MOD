...
from src.utils.utils import Logger, compute_performance
    ...
    for run_id in range(args.start_seed, args.start_seed + args.n_runs):
        ...
        if args.training_type == 'inc':
            ...
            for task_id in range(args.n_tasks):
                ...
                if args.learner == 'OCMCCLDC' or args.learner == 'OnProCCLDC':
                    ens_acc, ens_fgt, n1_acc, n1_fgt, n2_acc, n2_fgt = learner.evaluate(dataloaders, task_id) # evaluate_etf
                ...
                elif args.learner == 'MOSE':
                    acc_list, all_acc_list = learner.test(task_id, dataloaders)
                    tmp_acc.append(acc_list)
                    last_tmp_acc.append(all_acc_list[4])
