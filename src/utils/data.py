...
def get_loaders(args):
    ...
    if args.training_type == 'inc':
        dataloaders = add_incremental_splits(args, dataloaders, tf, tag="train", drop_last=drop_last)
        dataloaders = add_incremental_splits(args, dataloaders, tf, tag="test", drop_last=drop_last)
    
    dataloaders['train'] = DataLoader(dataset_train, batch_size=args.batch_size, shuffle=args.training_type != 'blurry', num_workers=args.num_workers, drop_last=drop_last)
    dataloaders['test'] = DataLoader(dataset_test, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, drop_last=drop_last)
...
def add_incremental_splits(args, dataloaders, tf, tag="train", drop_last=False):
    is_train = tag == "train"
